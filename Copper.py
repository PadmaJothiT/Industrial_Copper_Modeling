            ...
            if 'PRICE PREDICTION':
                ...
                with c1:
                    ...
                    if st.button('PREDICT PRICE'):
                        ...
                        with open('RandomForestRegression.pkl', 'rb') as f:
                            model = pickle.load(f)
                        ...
                        st.success(f'**Predicted Selling Price : :green[₹] :gold[{predicted_price}]**')
        except:
...
if selected=='STATUS PREDICTION':
        try:
            if 'STATUS PREDICTION':
                ...
                st.write('##### ***<span style="color:Purple">Fill all the fields and Press the below button to view the status :green[WON] / :red[LOST] of copper in the desired time range</span>***',
                            unsafe_allow_html=True)
